...
xdata = np.loadtxt("./data/2c_1_2_no_match.txt",delimiter=";")
xdata2 = np.loadtxt("./data/1c_1_2_new2.txt",delimiter=";")
...
for i in np.linspace(0,len(xdata[:,0]),301):
    ...
    plt.hist(xdata2[int(i),:],bins=200,alpha=0.5,label=r"$c_2 = c_1$")
    plt.ylim([0,1600])
    plt.xlim([0,2])
